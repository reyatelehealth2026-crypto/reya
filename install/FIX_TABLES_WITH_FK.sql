-- ============================================================================
-- FIX ODOO SYNC TABLES - Handles Foreign Key Constraints
-- ============================================================================

-- Disable foreign key checks temporarily
SET FOREIGN_KEY_CHECKS = 0;

-- Drop existing tables (now it will work even with FK constraints)
...
-- ============================================================================
-- 4. Add sync flag to webhook log
-- ============================================================================
ALTER TABLE `odoo_webhooks_log` 
ADD COLUMN IF NOT EXISTS `synced_to_tables` BOOLEAN DEFAULT FALSE;

-- Add index if it doesn't exist (MySQL will ignore if exists)
CREATE INDEX IF NOT EXISTS `idx_synced` ON `odoo_webhooks_log` (`synced_to_tables`, `processed_at`);
